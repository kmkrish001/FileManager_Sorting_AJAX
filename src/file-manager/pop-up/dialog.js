define(["require", "exports", "@syncfusion/ej2-popups", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "../common/operations", "../base/classes", "../base/constant", "../common/operations", "../common/utility", "@syncfusion/ej2-inputs", "@syncfusion/ej2-buttons"], function (require, exports, ej2_popups_1, ej2_base_1, ej2_base_2, operations_1, CLS, events, operations_2, utility_1, ej2_inputs_1, ej2_buttons_1) {
    ...
    function createDialog(parent, text, e, details, replaceItems) {
        ...
        if (ej2_base_1.isNullOrUndefined(parent.dialogObj)) {
            parent.dialogObj = new ej2_popups_1.Dialog({
                ...
                cssClass: utility_1.getCssClass(parent, parent.isMobile ? CLS.MOB_POPUP : CLS.ROOT_POPUP),
                width: '350px',
                open: options.open,
                close: options.close,
    ...
    function getFilesName(data) {
        var parent = ej2_base_1.createElement('div', { id: 'uploadDialog' });
        var ulElement = ej2_base_1.createElement('ul');
        ...
        for (var fileCount = 0; fileCount < filesData.length; fileCount++) {
            var liElement = ej2_base_1.createElement('li', { className: 'dialogFiles' });
            liElement.innerHTML = filesData[fileCount].name;
            ulElement.appendChild(liElement);
        }
        parent.appendChild(ulElement);
        var errorTag = ej2_base_1.createElement('div', { className: 'e-fe-error' });
    ...
    function onReSubmit(parent) {
        ...
        var newPath = (parent.activeModule === 'navigationpane') ? utility_1.getParentPath(parent.path) : parent.path;
    ...
    function createImageDialog(parent, header, imageUrl) {
        ...
        var image = ej2_base_1.createElement('img', { className: 'e-image', attrs: { src: imageUrl, alt: header } });
