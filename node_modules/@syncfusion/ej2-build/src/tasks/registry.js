 ...
 */
gulp.task('release-registry', function () {
    switchRegistry('http://nexus.syncfusion.com/repository/ej2-release/');
    npmrcConfig('//nexus.syncfusion.com/repository/ej2-release/');
});

/**
 * remote hotfix registry
 */
gulp.task('hotfix-registry', function () {
    switchRegistry('http://nexus.syncfusion.com/repository/ej2-hotfix/');
    npmrcConfig('//nexus.syncfusion.com/repository/ej2-hotfix/');
});
...
var setNpmrc = function (branchName) {
    ...
    if (common.isRemoteServer) {
        ...
        registry = isReleaseBranch ? '//nexus.syncfusion.com/repository/ej2-release/' : registry;
        registry = isHotfixBranch ? '//nexus.syncfusion.com/repository/ej2-hotfix/' : registry;
    } else {
