...
gulp.task('publish-ej2', function (done) {
    ...
    if (!fs.existsSync('./ej2-repo')) {
        ...
        var ej2Repo = 'https://' + user + ':' + token + '@github.com/essential-studio/ej2.git';
...
gulp.task('style-dependency', function (done) {
    ...
    if (!fs.existsSync(repoPath)) {
        ...
        var user = 'SyncfusionBuild';
        var token = process.env.GithubBuildAutomation_PrivateToken;
        var ej2ResourcesRepo = 'https://' + user + ':' + token + '@github.com/essential-studio/ej2-resources.git';
...
gulp.task('yeoman-es6-automation', function (done) {
    ...
    if (!fs.existsSync(repoPath)) {
        ...
        var user = 'SyncfusionBuild';
        var token = process.env.GithubBuildAutomation_PrivateToken;
        var es6GeneratorRepo = 'https://' + user + ':' + token + '@github.com/essential-studio/ej2-generator-es6.git';
...
gulp.task('yeoman-ts-automation', function (done) {
    ...
    if (!fs.existsSync(repoPath)) {
        ...
        var user = 'SyncfusionBuild';
        var token = process.env.GithubBuildAutomation_PrivateToken;
        var tsGeneratorRepo = 'https://' + user + ':' + token + '@github.com/essential-studio/ej2-generator-typescript.git';
